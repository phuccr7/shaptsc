...
from typing import Tuple, Sequence, Mapping, Dict, FrozenSet
...
def prepare_simdict_from_df(similarity_df: "pandas.DataFrame",
    ...
    for model_tuple, sims in grouped.items():
...
def _preprocess_model_names_and_labels(simdict, user_model_labels):
    ...
    if isinstance(user_model_labels, Mapping):
