...
def align_shapelets(model: "sktime.transformations.panel.shapelet_transform.ShapeletTransform", X: "pandas.DataFrame"):
...
class ShapeletTransformExplainer(Explainer[TimeExplanation]):
    ...
    def __init__(self, model: "sktime.transformations.panel.shapelet_transform.ShapeletTransform"):
        self.model = model
